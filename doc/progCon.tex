...
Ogni prodotto è acquistato presso un solo fornitore di fiducia. \medskip \\
...
\end{itemize}
Un fornitore può vendere più di un prodotto al ristorante.\medskip \\
...
Per ogni uscita deve essere specificata anche la motivazione o causale che ha generato il costo. \\
Ogni uscita può corrispondere o all'acquisto di un prodotto o al salario di un dipendente. \\
Ogni entrata corrisponde all'incasso derivante da un'ordine. \medskip \\
...
Per le \textbf{prenotazioni} effettuate dai clineti si vuole sapere:
\begin{itemize}
...
\begin{itemize}
    ...
    \item Data, che lo identifica univocamente
\end{itemize}
Ogni turno di lavoro comprende l'intera giornata, senza distinzione tra pranzo e cena.\newline
In ogni turno di lavoro devono essere presenti almeno un cuoco, un cameriere ed un sommelier. 
...
\begin{longtable}{p{2.5cm} p{6cm} p{2cm} p{5.5cm}}
    ...
    Prenotazione & Prenotazione di un tavolo del ristorante & & Tavolo \\ \midrule
    ...
    Turno & Turno lavorativo dei dipendenti & & Personale	\\ \midrule
\end{longtable}

\subsection{Operazioni}
\begin{description}
    \item [Operazione 1:] inserimento di un nuovo prodotto.
    \item [Operazione 2:] modificare la quantita di un prodotto, se la quantità è 0 allora viene aumentata generando una nuova uscita (viene gestito da un'altra procedura).
    \item [Operazione 3:] inserimento di una nuova prenotazione.
    \item [Operazione 4:] cancella prenotazione solo se la prenotazione è successiva alla data corrente.
    ...
    \item [Operazione 8:] stampare il codice, il nome, la marca e l’annata di tutti i vini con annata risalente a massimo il 2008 e prezzo inferiore a 20 euro ordinati per prezzo crescente.
    \item [Operazione 9:] stampa il numero dei tavoli liberi nel giorno 20/02/2019 che non hanno 3 e 5 coperti.
    \item [Operazione 10:] stampare nome e cognome di tutti i dipendenti di turno il martedì, raggruppati per ruolo il cui stipendio medio è maggiore di 2000.
    \item [Operazione 11:] calcolare il guadagno mensile dato dalla differenza tra la somma delle entrate e la somma delle uscite.
    \item [Operazione 12:] trovare il cameriere che effettua più ordini in media al giorno per decidere se promuoverlo o no.
\end{description}
...
\begin{longtable}{|p{ 17cm}|}
    ...
    Per i prodotti da frigo, o freschi, si vuole inoltre conoscere la data di scadenza. Ogni prodotto è acquistato presso un solo fornitore di fiducia.\\ \hline
\end{longtable}
...
\begin{longtable}{|p{17 cm}|}
    ...
    Ogni prenotazione ha: un nome del cliente prenotante, il giorno della prenotazione, l'ora della prenotazione, un numero di persone al tavolo e il numero del tavolo. 
    Ogni prenotazione è identificata univocamente da giorno, ora e numero del tavolo.
...
\begin{longtable}{|p{17 cm}|}
    ...
    Ogni turno di lavoro ha: un codice del dipendente, un giorno ed una data. \\
    Ogni turno di lavoro viene identificato univocamente dalla data.
    Ogni turno di lavoro comprende l’intera giornata, senza distinzione tra pranzo e cena.
    In ogni turno di lavoro devono essere presenti almeno un cuoco, un cameriere ed un sommelier.
    \\ \hline
\end{longtable}
...
\begin{itemize}
    ...
    \item Il numero del tavolo deve essere compreso tra 1 e 20.
...
\begin{longtable}{p{2.5cm} p{5.5cm} p{5.5cm} p{2.5cm}}
    ...
    Turno & Turno di lavoro & Giorno, Data & Data\\ 
    \bottomrule	
\end{longtable}
