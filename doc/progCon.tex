...
\begin{itemize}
    \item Codice prenotazione che la identifica univocamente %identificato anche da giorno ora e tavolo
...
\subsection{Strutturazione dei requisiti} %%da cambiare dopo l eliminazione di piatti ecc
